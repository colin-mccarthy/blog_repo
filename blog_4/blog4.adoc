...
This role is not a completed out of the box solution for network ticket. What it is meant to be is merely a starting point that accelerates your adoption of automating ServiceNow with Ansible.
